...
if (count($_POST)) {
    if (isCpfValid($_POST['document'])) {
    } else {
        echo '<div class="card-footer">
                    <a href="/crud/project/form-edit/'. $id .'" class="btn btn-danger"><i class="fa fa-hand-point-left"></i><br> <b>Favor Informe Um CPF Válido</b><br></a>
                    </div>';
        return;
    }
}
...
if (count($_POST) > 0) {
    try {
        ...
        echo "<p>Erro ao alterar o usuario!</p>";
        exit;
    }
}
                ...
                <form method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                ...
                                <input type="text" name="complement" id="complement" class="form-control"
                                       value="<?php echo $address['complement']; ?>">
                            </div>
                        </div>
                    ...
                    <div class="card-footer">
                        ...
                        <button type="submit" class="btn btn-success">
                            Alterar <i class="fa fa-paper-plane"></i>
                        </button>
                    </span>
                    </div>
                </form>
